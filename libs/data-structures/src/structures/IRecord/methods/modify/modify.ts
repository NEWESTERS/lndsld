...
type ModifyTransform<K extends AnyKey, V1, V2> = <R extends IRecord<K, V1>>(
	record: R
) => V2 extends V1 ? R : IRecord.OverrideProperty<R, K, V2>;

function modify<K extends AnyKey, V1, V2>(key: K, callback: Transform<V1, V2>): ModifyTransform<K, V1, V2> {
